...
const Navbar = () => {
  ...
  const [isOpen, setIsOpen] = useState(false);
	...
	return (
		<div
			className={`navbar px-3 lg:px-12 py-4 fixed z-10 ${
		...
		>
			<div className="navbar-start">
				<div className="dropdown rounded-none ">
					<label
						tabIndex={0}
						className="btn  lg:hidden bg-gray-400"
					...
					{isOpen && (
						...
						>
							...
							<Link className="btn btn-sm bg-gray-400 text-neutral" onClick={handleLogOut}>
								Logout
							</Link>
						</ul>
					)}
				...
				>
					<span className=' text-yellow-600 pl-1 lg:pl-0'>Lens</span>Crafters
				</a>
			</div>
			...
			<div className="navbar-end gap-5">
				{user ? (
					...
					<Link to="/login" className="btn bg-gray-400 text-neutral">
						Login
					</Link>
				)}
			</div>
